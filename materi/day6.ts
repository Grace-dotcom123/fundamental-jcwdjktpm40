...
const user: User = {
    name: "joko", // kiri: key, kanan : value
    email: "joko@mail.com",
    job: "programmer",
    address: {
        street: "Jl setiabudi",
        city: "Jakarta Selatan",
        postalCode: "12345", // liat tipe kedepannya ada kalkulasiin ga kl gaada better dijadiin string
    },
    hobby: ["mancing", "ngoding", "berenang"],
    makan(){
        console.log("makan");
    },
};
...
// const orang2 = orang1;
const orang2: any = { ...orang1 }; // shallow copy -> dia hanya copy bagian luar aja, kl mau bagian dalamnya juga pake deep copy
...
const result = {...objectOne, ...objectTwo}; // kl misal ada 2 property yg sama maka yg kanan (objectTwo) ada menimpa yang kiri (objectOne)
...
// ============ CONSTRUCTOR =========
// method bawaan class yang akan dijalankan pertama kali saat membuat object baru

class Vehicle {
    brand: string;
    type: string;
    #chassisNumber: string; // # -> bersifat private, jd diluar class tidak bisa diakses
...
const kendaraan2 = new Vehicle("Honda", "Brio", "321-321-321");
console.log(kendaraan2.brand);
console.log(kendaraan2.type);
console.log(kendaraan2.start());
console.log(kendaraan2["#chassisNumber"]);//private
